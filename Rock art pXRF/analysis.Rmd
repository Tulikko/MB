...
biplot(pca_P4, choices = 1:2, cex = c(0.5, 0.7), col = c("grey80", "deeppink2"), main = "PCA_P4")
autoplot(pca_P4, data=nP, colour='Type', shape = FALSE, label = TRUE,  main = "PCA_P4")
...
biplot(pca_V4, choices = 1:2, cex = c(0.5, 0.7), col = c("grey80", "deeppink2"), main = "PCA_P4")
autoplot(pca_V4, data=nV, colour='Type', shape = FALSE, label = TRUE,  main = "PCA_P4")

biplot(pca_V6, choices = 1:2, cex = c(0.5, 0.7), col = c("grey80", "deeppink2"), main = "PCA_P6")
autoplot(pca_V6, data=nV, colour='Type', shape = FALSE, label = TRUE,  main = "PCA_P6")
