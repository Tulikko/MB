...
Results <- read.xlsx("Raw_Israel.xlsx", sep=";")
...
write.xlsx(avrg_n1, file="Israel-n1-pXRF.xlsx")
write.xlsx(avrg_n2, file="Israel-n2-pXRF.xlsx")
write.xlsx(avrg_z1, file="Israel-z1-pXRF.xlsx")
write.xlsx(avrg_z2, file="Israel-z2-pXRF.xlsx")
