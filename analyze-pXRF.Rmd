...
colnames(n2)
n2 <- n2 %>% select(MgO, Ti, Mn, Fe, Cu, Zn, Sr, Zr)
...
autoplot(pam(n2, 2), frame = TRUE, frame.type = 'norm')
autoplot(pam(n2, 3), frame = TRUE, frame.type = 'norm')
autoplot(pam(n2, 4), frame = TRUE, frame.type = 'norm')
autoplot(pam(n2, 5), frame = TRUE, frame.type = 'norm')
autoplot(pam(n2, 6), frame = TRUE, frame.type = 'norm')
autoplot(pam(n2, 7), frame = TRUE, frame.type = 'norm')
autoplot(pam(n2, 8), frame = TRUE, frame.type = 'norm')
