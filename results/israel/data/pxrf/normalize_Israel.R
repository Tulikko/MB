...
Results <- read.xlsx("data/Raw_Israel.xlsx", sep=";")
...
rownames(avrg_n) <- avrg_n$Sample
rownames(avrg_z) <- avrg_z$Sample
...
# Create new "Sample" from "Group.1" etc., remove duplicates
...
write.xlsx(avrg_n1, file="data/Israel-n1-pXRF.xlsx")
write.xlsx(avrg_n2, file="data/Israel-n2-pXRF.xlsx")
write.xlsx(avrg_z1, file="data/Israel-z1-pXRF.xlsx")
write.xlsx(avrg_z2, file="data/Israel-z2-pXRF.xlsx")
