...
# NO COPPER: Elements
pxrf_noCuMB <- pxrf_MB[-7]
colnames(pxrf_noCuMB[3:11])

# NO COPPER: PCA analysis
pca_2 <- prcomp(pxrf_noCuMB[3:11])
summary(pca_2)
...
autoplot(pca_2, data=pxrf_noCuMB, colour='Area', shape = FALSE, label = TRUE,  main = "PCA Palaepaphos grouped by area (NO COPPER)")

PCA(pxrf_MB[3:12])
PCA(pxrf_noCuMB[3:11])
...
plot(dend, main="HCA with sample areas (NO COPPER)")
