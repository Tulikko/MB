...
# Draw spectra
ggplot(spectra_MB, aes(x=Temperature, y=Loss, color=Name, group=Name)) +
    geom_line() +
...
spectra_D <- filter(spectra_MB, grepl('PP-9', Name))

x = (spectra_D$Temperature)
y = (spectra_D$Weight)
...
# Draw spectra
ggplot(spectra, aes(x=Temperature, y=Loss, color=Name, group=Name)) +
    geom_line() +
