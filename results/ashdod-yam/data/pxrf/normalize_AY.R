...
Results <- read.xlsx("Raw_AY.xlsx", sep=";")
...
write.xlsx(avrg_n1, file="AY-n1-pXRF.xlsx")
write.xlsx(avrg_n2, file="AY-n2-pXRF.xlsx")
write.xlsx(avrg_z1, file="AY-z1-pXRF.xlsx")
write.xlsx(avrg_z2, file="AY-z2-pXRF.xlsx")
