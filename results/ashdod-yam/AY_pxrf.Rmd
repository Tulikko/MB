...
biplot(pca_2, choices = 1:2, cex = c(1, 1.2), col = c("grey80", "deeppink2"), main = "PCA Ashdod-Yam elements (NO COPPER)")

autoplot(pca_1, data=pxrf_final, colour='Area', shape = FALSE, label = TRUE,  main = "PCA Ashdod-Yam grouped by area")
autoplot(pca_2, data=pxrf_noCu, colour='Area', shape = FALSE, label = TRUE,  main = "PCA Ashdod-Yam grouped by area (NO COPPER)")

autoplot(pca_1, data=pxrf_final, colour='Type', shape = FALSE, label = TRUE,  main = "PCA Ashdod-Yam grouped by sample type")
autoplot(pca_2, data=pxrf_noCu, colour='Type', shape = FALSE, label = TRUE,  main = "PCA Ashdod-Yam grouped by sample type (NO COPPER)")
...
dend2 <- 
    ...
    rect.dendrogram(dend2, 6, border = "Black", lty = 5)
    legend("topright", legend = levels(area), fill = cols_a)
