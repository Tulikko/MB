...
biplot(pca_2, choices = 1:2, cex = c(1, 1.2), col = c("grey80", "deeppink2"), main = "PCA Artaxata elements (NO COPPER)")

autoplot(pca_1, data=pxrf_final, colour='Area', shape = FALSE, label = TRUE,  main = "PCA Artaxata grouped by area")
autoplot(pca_2, data=pxrf_noCu, colour='Area', shape = FALSE, label = TRUE,  main = "PCA Artaxata grouped by area (NO COPPER)")
